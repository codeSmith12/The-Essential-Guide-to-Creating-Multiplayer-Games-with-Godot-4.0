...
func load_database(path_to_database = database_file_path):
	var file = FileAccess.open(path_to_database,FileAccess.READ)
...
func retreive_avatar(user, session_token):
